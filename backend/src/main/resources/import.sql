...
INSERT INTO `user` ( name, celphone,  email, password, user_id, role_id) values ('Coach ceilandia', '61 991972551', 'p1@admin.com', '$2a$10$o5vhWUGZJ5rFKCVPGtD6hObB057TXLvqYny6Kss2FJTPfMg7HZy1a', 3, 2);
INSERT INTO `user` ( name, celphone,  email, password, user_id, role_id) values ('Student ceilandia', '61 991972551', 'a1@admin.com', '$2a$10$o5vhWUGZJ5rFKCVPGtD6hObB057TXLvqYny6Kss2FJTPfMg7HZy1a', 4, 3);
